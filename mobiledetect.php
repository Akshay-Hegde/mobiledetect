 ...
 * This plugin is an implementation of the Mobile Detect library by Victor Stanciu & Serban Ghita (https://github.com/serbanghita/Mobile-Detect)
 *
 * @author		Luis Escobar Bravo
 * @package		PyroCMS\Addon\Plugins
 * @copyright	MIT
 */
class Plugin_mobiledetect extends Plugin
{
    ...
    */
    ...
    public function setHttpHeaders($httpHeaders = null){
        ...
        $httpHeaders = $this->attribute('httpHeaders', $httpHeaders);
    ...
    public function setUserAgent($userAgent = null){
        ...
        $userAgent = $this->attribute('userAgent', $userAgent);
...
*/
    ...
    */
    ...
    function match($regex, $userAgent=null){
        ...
        $regex = $this->attribute('regex', $regex);
    ...
    function version($propertyName, $type = 'text'){
        ...
        $propertyName = $this->attribute('propertyName', $propertyName);
